  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: ScaffoldPageView,
        meta: { title: '出库异常', permission: 'anomaly-outbound', groupTitle: '异常管理' },
      },
      {
        path: 'anomalies/inbound',
        name: 'anomaly-inbound',
        component: ScaffoldPageView,
        meta: { title: '到仓不齐', permission: 'anomaly-inbound', groupTitle: '异常管理' },
      },
      {
        path: 'anomalies/shelving',
        name: 'anomaly-shelving',
        component: ScaffoldPageView,
        meta: { title: '上架异常', permission: 'anomaly-shelving', groupTitle: '异常管理' },
      },
      {
        path: 'settings/alerts',
        name: 'settings-alerts',
        component: ScaffoldPageView,
        meta: { title: '提醒配置', permission: 'settings-alerts', groupTitle: '系统设置' },
      },
    ],
  },
]
