...
const query = reactive<ShelvingQuery>({ pageNo: 1, pageSize: 20 })

async function fetchData() {
  loading.value = true
  try {
    const res = await anomaliesApi.shelving({ ...query, riskStatus: query.riskStatus || undefined })
...
<template>
  <div class="anomaly-page">
    ...
    <el-table v-loading="loading" :data="tableData" size="small" stripe border>
      ...
      <el-table-column label="到仓时间" width="170">
